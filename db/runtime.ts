...
export async function ensureGameSchema() {
  ...
  await db.batch([
    ...
    db.prepare("CREATE TABLE IF NOT EXISTS scores (id INTEGER PRIMARY KEY AUTOINCREMENT, player_id INTEGER NOT NULL, room_code TEXT NOT NULL, grade_band TEXT NOT NULL, game_id TEXT NOT NULL, score INTEGER NOT NULL, remaining_budget INTEGER NOT NULL DEFAULT 0, created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP)"),
